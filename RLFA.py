...
class Parsing(CSP):
    def __init__(self, file_name):
        ...
        # Initialize the CSP
        CSP.__init__(self, self.variables, self.variables_lists_of_values, self.neighbors, self.check_constraint, self.weights, self.tuples_constraints)
